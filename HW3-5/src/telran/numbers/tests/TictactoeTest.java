...
class TictactoeTest {
	...
	char matrixWinnerMiddleRowO[][] = {
			{'x', '0', 'x'},
			{'0', '0',  0 },
			{'x' ,'x',  0 }
	};
	char matrixWinnerDownRowO[][] = {
			{'x', '0', '0'},
			{'0', '0',  'x' },
			{'x' ,'x',  0 }
	};
	...
	assertEquals(1, TictactoeGame.tictactoeMove(matrixWinnerMiddleRowO, 2, 1, '0'));
	assertEquals(1, TictactoeGame.tictactoeMove(matrixWinnerDownRowO, 2, 2, 'x'));
